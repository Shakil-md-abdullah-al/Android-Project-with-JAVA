...
public class Database extends SQLiteOpenHelper {
    ...
    //On android SQLite database is the default database
    @Override
    ...
    public void register(String username,String email ,String password){
        ...
        //for insert update delete use getwritetable() db
        //for fetch getreaddatabase()
        SQLiteDatabase db = getWritableDatabase();
        db.insert("users",null, cv);
        db.close();
    }

    //Login in function validation
...
//Cart Functions Start
    ...
    public ArrayList<String> getOrderDataa(String username) {
        ArrayList<String> arr = new ArrayList<>();
        SQLiteDatabase db = getReadableDatabase();

        if (db == null) {
            // Handle the error gracefully (e.g., log the error, show a message)
            // and return an empty ArrayList or null.
            return arr;
        }
        ...
        c.close(); // Close the cursor before closing the database.
        db.close(); // Close the database after using it.
        return arr;
    }
